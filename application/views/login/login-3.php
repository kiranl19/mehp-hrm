		...
		<div class="page responsive-log relative error-page3">
			<div class="row no-gutters">
				<div class="col-xl-6  d-xl-block d-none log-image1">
					<div class="cover-image h-100vh" data-bs-image-src="<?php echo base_url() ?>assets/images/photos/login3.jpg">
						<div class="container">
						...
						<div class="customlogin-content pt-5 pt-xl-9">
							<div class="pt-4 pb-2 ps-2">
								<a class="header-brand" href="index.html">
									<img src="<?php echo base_url() ?>assets/images/brand/logo.png" class="header-brand-img custom-logo" alt="Dayonelogo">
									<img src="<?php echo base_url() ?>assets/images/brand/logo-white.png" class="header-brand-img custom-logo-dark" alt="Dayonelogo">
								</a>
							</div>
							<div class="p-4 pt-6">
