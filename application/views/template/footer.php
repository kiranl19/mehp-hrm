	...
	<div class="container">
		<div class="row align-items-center flex-row-reverse">
			<div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center">
				Copyright © 2022 <a href="javascript:void(0);">Market-Expertise</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0);">Hello Prospect</a> All rights reserved.
			</div>
		</div>
	</div>
</footer>
...
<script src="<?php echo base_url() ?>assets/plugins/apexchart/apexcharts.js"></script>
...
<script src="<?php echo base_url() ?>assets/plugins/chart.min/chart.min.js"></script>
<script src="<?php echo base_url() ?>assets/plugins/chart.min/rounded-barchart.js"></script>

<!-- INTERNAL jQuery-countdowntimer js -->
<script src="<?php echo base_url() ?>assets/plugins/jQuery-countdowntimer/jQuery.countdownTimer.js"></script>
